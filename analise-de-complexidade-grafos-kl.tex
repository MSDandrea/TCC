...
\begin{itemize}
  ...
  \item Grafo(0,4)
\end{itemize}
Sabemos também que coloração é de solução trivial para cliques, independentes, para grafos split e para grafos bipartidos portanto podemos obter a seguinte tabela
