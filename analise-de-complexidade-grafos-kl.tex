...
% PARTE
% ----------------------------------------------------------
\part{Análise do problema de coloração para Grafos(k,l)}
% ----------------------------------------------------------

% ---
% Capitulo de revisão de literatura
% ---
\chapter{Evolução do problema de coloração considerando o crescimento de k e l}
% ---
...
\begin{itemize}
  \item Grafo(1,2):
    ...
    \end{proof}
    \begin{corolario}
    Seja G uma instância de lista coloração onde G é uma (k,l) partição e seja c o número de cores utilizadas em G, existe um grafo $H_G$ (k,l+1) particionável tal que G é uma instância sim de lista coloração, se e somente se $H_G$ é c-colorível
    \end{corolario}
    \begin{corolario}
