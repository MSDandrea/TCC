...
% ---
\titulo{Análise de complexidade parametrizada em problemas clássicos para Grafos(2,1)}
...
% ---
\begin{siglas}
  \item[\textit{L}] Complexidade de tempo Linear
  \item[\textit{P}] Complexidade de tempo Polinomial determinístico
  \item[\textit{NP}] Complexidade de tempo Polinomial não determinístico
\end{siglas}
% % ---
%
% % ---
...
Sabemos também que coloração é de solução linear tanto para grafos split quanto para grafos bipartidos portanto podemos obter a seguinte tabela
...
\begin{table}[htb!]
  ...
  \begin{tabular}{l|*{6}c}
    ...
    \midrule
    0 & \textit{L} & \textit{L} & \textit{P} & ? & \textit{NP} & \textit{NP}\\
    1 & \textit{L} & \textit{P} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP}\\
    2 & \textit{P} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP}\\
    3 & \textit{P} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP}\\
    4 & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP}\\
    n & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP} & \textit{NP}\\
    \bottomrule
  \end{tabular}%
