...
\begin{document}
    ...
    \begin{frame}{Conceitos iniciais}
      \begin{columns}
        ...
        \begin{column}{0.5\textwidth}
          ...
          Uma coloração de um grafo $G$ é uma associação de uma cor entre $q$ cores a cada vértice do grafo de forma que, dado dois vértices vizinhos em $G$ eles não compartilhem uma cor, e $q$ seja o menor número de cores possíveis a respeitar tal restrição. 
        \end{column}
      \end{columns}
    \end{frame}
    ...
    \begin{frame}{Primeiros passos}
      ...
      \begin{itemize}
        ...
        \item Um grafo sem arestas (i.e. um Grafo$(1,0)$) é 1-colorível.
        \item Um grafo bipartido (i.e. um Grafo$(2,0)$) é 2-colorível.
        \item Um grafo completo (i.e. um Grafo$(0,1)$) é $n-colorivel$ onde $n$ é a quantidade de vértices de G.
        \item                                                                                                               
      \end{itemize}
    \end{frame}
    \begin{frame}{Primeiros passos}
      ...
      \begin{itemize}
        ...
        \item Um grafo sem arestas (i.e. um Grafo$(1,0)$) é 1-colorível.
        \item Um grafo bipartido (i.e. um Grafo$(2,0)$) é 2-colorível.
        \item Um grafo completo (i.e. um Grafo$(0,1)$) é $n-colorivel$ onde $n$ é a quantidade de vértices do grafo.
...
\end{proof}
     ...
     \begin{frame}{Árvore de altura limitada}
       \begin{figure}[H]
        \centering
        \fontsize{4}{10}
        \includesvg[scale=0.5]{bound-tree-k.svg}
      \end{figure}
     \end{frame}
     \begin{frame}{Árvore de altura limitada}
       \begin{figure}[H]
        \centering
        \fontsize{4}{10}
        \includesvg[scale=0.5]{bound-tree-k-1.svg}
      \end{figure}
     \end{frame}
     \begin{frame}{Árvore de altura limitada}
       \begin{figure}[H]
        \centering
        \fontsize{4}{10}
        \includesvg[scale=0.5]{bound-tree-k-n.svg}
      \end{figure}
     \end{frame}
     \begin{frame}{Árvore de altura limitada}
       \begin{figure}[H]
        \centering
        \fontsize{4}{10}
        \includesvg[scale=0.5]{bound-tree-k-k.svg}
      \end{figure}
     \end{frame}
     \section{Conclusão}
