...
\begin{corolario}
	...
	\begin{proof}
		A NP-Completude de lista coloração em grafos split i.e. Grafos$(1,1)$ é demonstrado por Jansen et al.\cite{jansen1997}.
	\end{proof}
\end{corolario}
\begin{corolario}
	O problema de coloração é NP-Completo em Grafos$(2,1)$.
	\begin{proof}
		A NP-Completude de lista coloração em grafos bipartido é demonstrado por Fellows et al.\cite{fellows07}.
	\end{proof}
\end{corolario}    
\begin{corolario}
