...
Portanto essa seção será dividida em 2 casos, um contendo vértices de listas tamanho um, outro contendo vértices com listas de tamanhos dois, e finalizado contendo listas de tamanho 1 e 2.
\subsection{Apenas vértices com listas tamanho um}
Os seguintes teoremas estabelecem a base para a resolução do problema envolvendo os vizinhos da clique. 
\begin{teorema}
